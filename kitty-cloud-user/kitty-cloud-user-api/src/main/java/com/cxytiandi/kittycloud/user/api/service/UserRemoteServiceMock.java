...
import com.cxytiandi.kittycloud.common.exception.FallbackException;
...
public class UserRemoteServiceMock implements UserRemoteService {
    ...
    public ResponseData<UserResponse> getUser(Long userId) {
        log.error(MessageFormat.format("UserRemoteService.getUser fallback，参数为 [{0}]", userId), new FallbackException());
